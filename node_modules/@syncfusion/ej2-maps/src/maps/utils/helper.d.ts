...
import { MarkerType, IShapeSelectedEventArgs, ITouches, IShapes, SelectionSettingsModel, HighlightSettingsModel, IMarkerRenderingEventArgs, MarkerSettings, SameMarkerClusterData } from '../index';
/**
...
export declare function clusterTemplate(currentLayer: LayerSettings, markerTemplate: HTMLElement | Element, maps: Maps, layerIndex: number, markerCollection: Element): HTMLElement | Element;
export declare function mergeSeparateCluster(sameMarkerData: SameMarkerClusterData[], maps: Maps, markerElement: Element | HTMLElement): void;
export declare function clusterSeparate(sameMarkerData: SameMarkerClusterData[], maps: Maps, markerElement: Element | HTMLElement, isDom?: boolean): void;
 ...
 */
export declare function checkShapeDataFields(dataSource: object[], properties: object, dataPath: string, propertyPath: string | string[]): number;
 ...
 * @private
 */
export declare function triggerShapeEvent(targetId: string, selection: SelectionSettingsModel | HighlightSettingsModel, maps: Maps, eventName: string): IShapeSelectedEventArgs;
/**
 ...
 */
export declare function createStyle(id: string, className: string, eventArgs: IShapeSelectedEventArgs): Element;
/**
 * Function to customize the style for highlight and selection
 */
export declare function customizeStyle(id: string, className: string, eventArgs: IShapeSelectedEventArgs): void;
/**
